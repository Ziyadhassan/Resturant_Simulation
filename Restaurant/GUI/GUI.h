...
public:
	...
	void AddToDrawingList(Linked_List<Cook> L1, Linked_List<Cook> L2, Linked_List<Cook> L3);  //Adds cooks to the drawing queue
	void AddToDrawingList(Linked_List<Order> LL); //Adds order (Serving) to the drawing queue
	void AddToDrawingList(Queue<Order> LL);       //Adds order (Waiting) to the drawing queue
	void AddToDrawingList(Priority_Queue<Order> LL, Queue<Order> L2); //Adds order (Waiting) to the drawing queue
